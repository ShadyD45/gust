...
| **Phase 9** | [`phase-09-cli-ci-and-demo.md`](file:///d:/Projects/gust/docs/plans/mvp/phase-09-cli-ci-and-demo.md) | Cobra CLI commands, CI exit codes, JSON/table formatters, killer demo end-to-end verification. |
