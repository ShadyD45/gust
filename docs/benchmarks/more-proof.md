...
| **Live-agent Mode 3** | [Live-agent demo]({% link usage/live-agent-demo.md %}) | Live `llama3.2:3b` N=20 Wilson PASS on healthy/recovery; FAIL on no-retry and forbidden refund |
