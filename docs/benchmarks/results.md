...
_Self-benchmark only — [metrics explained]({% link benchmarks/metrics.md %}) · [methodology]({% link usage/aee-methodology.md %}) · [repo RESULTS.md](https://github.com/ShadyD45/gust/blob/main/benchmarks/RESULTS.md)._
