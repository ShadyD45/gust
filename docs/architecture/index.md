...
| [Execution modes]({% link architecture/execution-modes.md %}) | Analyze / Replay / Test and data flow |
...
Looking for task-oriented guides rather than design rationale? See [Usage]({% link usage/index.md %}) to run gust against your own agent, and [Extending]({% link extending/index.md %}) to add evaluators, runners, or cross-language plugins.
